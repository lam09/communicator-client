...
public class TestPrintActivity extends AppCompatActivity implements Runnable{
        ...
        mScan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View mView) {
                ...
                if (mBluetoothAdapter == null) {
                    Toast.makeText(TestPrintActivity.this, "Message1", Toast.LENGTH_SHORT).show();
                } else {
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        ListPairedDevices();
                        Intent connectIntent = new Intent(TestPrintActivity.this,
        ...
        switch (mRequestCode) {
            case REQUEST_CONNECT_DEVICE:
                if (mResultCode == Activity.RESULT_OK) {
                   ...
                   // Snackbar.make(mDataIntent., "Replace with your own action", Snackbar.LENGTH_LONG)
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            Toast.makeText(TestPrintActivity.this, "DeviceConnected", Toast.LENGTH_SHORT).show();
        }
    };
